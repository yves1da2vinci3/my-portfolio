...
const projects = [
    {
      ...
      description: "Il s'agit d'une plateforme qui permet aux designers de se connecter ,de faire la veille technologique ,de poster leurs creations et ecrire des articles.",
    ...
    },
    {
      ...
      description: "Tantie Fatou est un restaurant specialise dans la vente de produit fait a base de banane",
    ...
    },
    {
      ...
      description: "Il s'agit de l'application web du service messagerie whatsapp avec les fonctionalite comme messagerie instantée ,messagerie vocale,statut,Envoi de media,Lecture des media pour un chat particulier etc ",
      technologies: ["Reactjs", "Tailwindcss", "Firebase","React-icons","Context Api"],
      githubLink: "https://github.com/",
    ...
    },
    {
      ...
      projectType : 1,
      preview: ResidenceIT,
      subtitle: "Un site pour la mise en relation entre des clients et proprietaire de logements",
      description: "Ce site permet la creation de compte resident ,la gestion des logments ,la gestion des demandes de residence",
      technologies: ["Reactjs", "Tailwindcss", "ExpressJs","Mongodb","Firebase","RecoilJs"],
      githubLink: "https://github.com/",
    ...
    },
    {
      ...
      projectType : 1,
      preview: Bolstarr,
      subtitle: "Un site qui met en relation les agriculteurs et les fourniesseurs outils agricole",
    ...
    },
    {
      ...
      description: "Une application qui gere les taches muni d'un systeme d'authentification le tout effectue sans une base de données",
    ...
    },
    {
      ...
      description: "Avec les fonctionalites comme l'authentication,la lecture de videos ,ajout de commentaires,ajout de musique ,post",
      technologies: ["React Native", "ContextApi", "AsyncStorage","React native elements","Superbase"],
      githubLink: "https://github.com/",
      openLink: "https://firebasestorage.googleapis.com/v0/b/myportfolio-527e2.appspot.com/o/VideoServices%2Ffd.mp4?alt=media&token=08d8a70f-012d-462e-b960-dfca7ca33fa7",
    },
    {
      title: "WhatsApp",
      type: "mobile",
      ...
      description: "Il s'agit du clone de l'application mobile du service messagerie whatsapp avec les fonctionalite comme messagerie instantée ,messagerie vocale,statut,Envoi de media,Lecture des media pour un chat particulier etc ",
      technologies: ["React Native", "ContextApi", "AsyncStorage","React native elements"],
      githubLink: "https://github.com/",
      openLink: "https://firebasestorage.googleapis.com/v0/b/myportfolio-527e2.appspot.com/o/VideoServices%2FSimulator%20Screen%20Recording%20-%20iPhone%2013%20-%202023-07-17%20at%2000.33.04.mp4?alt=media&token=df5eae76-0fd2-4e57-943d-66851d35733a",
    },
    {
      ...
      description: "Cette Application met en relation les prestataires de services et les clients ,elle est muni d'un systeme de notification ,de messagerie instantee,de voir l'evolution de nos paiments recues et l'evolution de la demande de notre offre etc",
    ...
    },
    {
      ...
      githubLink: "https://github.com/",
      openLink: "https://xd.adobe.com/view/999b9794-bd5b-4c03-ac19-2c06a6de8284-ccc8/?fullscreen",
    },
    {
      title: "BolstarUi",
      type: "Ui",
      projectType : 3,
      preview: BolstarUI,
      subtitle: "Design de l'application web de mise en relation entre agriculteurs et fournisseurs de produits agricoles ",
      description: "Design de l'application web de mise en relation entre agriculteurs et fournisseurs de produits agricoles",
      technologies: ["ADOBE XD", "ADOBE PHOTOSHOP", "Adobe Illustrator"],
      githubLink: "https://github.com/",
      openLink: "https://xd.adobe.com/view/1cc84212-fbe5-4511-9e92-d85b5f884699-499b/screen/93b526d1-4a45-44bc-b0c1-1d4ec60b8b5b?fullscreen",
    },
  ];
